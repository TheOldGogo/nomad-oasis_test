![docker image](https://github.com/TheOldGogo/nomad-oasis_test/actions/workflows/docker-publish.yml/badge.svg)


# TheOldGogo's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of TheOldGogo.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/TheOldGogo/nomad-oasis_test.git
    cd nomad-oasis_test
    ```
    ...
    ```sh
    curl-L -o nomad-oasis_test.zip "https://github.com/TheOldGogo/nomad-oasis_test/archive/main.zip"
    unzip nomad-oasis_test.zip
    cd nomad-oasis_test
    ```
...
your `docker-compose.yaml` with `ghcr.io/theoldgogo/nomad-oasis_test:main` for the services
...
```sh
docker pull ghcr.io/theoldgogo/nomad-oasis_test/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/TheOldGogo/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/TheOldGogo/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/TheOldGogo/nomad-oasis_test/manifests/main": unauthorized`
